...
namespace Votations.NSurvey.WebAdmin
{
	...
	/// </summary>
    public partial class VNPTItemReport : PageBase
	{
        ...
        protected void rbListSelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                case "GR": Response.Redirect(UINavigator.VNPTGroupReportHyperlink); break;
                case "TR": Response.Redirect(UINavigator.VNPTItemReportHyperlink); break;
            }
        }
        ...
        {   
			FieldReportTitle.Text = "Báo cáo theo chỉ tiêu";
            ...
            ((ButtonColumn)FieldReportDataGrid.Columns[1]).Visible = false;// CheckRight(NSurveyRights.DeleteVoterEntries, false);
		...
		private void BindData()
		{
			...
			DataSet textEntries = new Voters().GetVotersByItem(SurveyId);

			FieldReportDataGrid.DataSource = textEntries ;
			FieldReportDataGrid.DataKeyField = "QuestionId";
