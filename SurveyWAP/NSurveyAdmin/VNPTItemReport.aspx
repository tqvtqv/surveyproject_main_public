...
<%@ Page language="c#" MasterPageFile="MsterPageTabs.master"   AutoEventWireup="false" 
    Inherits="Votations.NSurvey.WebAdmin.VNPTItemReport" Codebehind="VNPTItemReport.aspx.cs" %>
                ...
                <ol>
                    <li>
                        ...
                        <asp:RadioButtonList runat="server" ID="rblReports" RepeatDirection="Vertical"
                            ...
                            Width="700px">
                            <asp:ListItem Text="Theo Đơn vị" Value="GR"></asp:ListItem>
                            <asp:ListItem Text="Theo chỉ tiêu" Value="TR" Selected="True"></asp:ListItem>
                        </asp:RadioButtonList>
