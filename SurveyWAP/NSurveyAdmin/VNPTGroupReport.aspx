...
<%@ Page language="c#" MasterPageFile="MsterPageTabs.master"   AutoEventWireup="false" 
    Inherits="Votations.NSurvey.WebAdmin.VNPTGroupReport" Codebehind="VNPTGroupReport.aspx.cs" %>
                ...
                <ol>
                    <li>
                        ...
                        <asp:RadioButtonList runat="server" ID="rblReports" RepeatDirection="Vertical"
                            ...
                            Width="700px">
                            <asp:ListItem Text="Theo Đơn vị" Value="GR" Selected="True"></asp:ListItem>
                            <asp:ListItem Text="Theo chỉ tiêu" Value="TR" ></asp:ListItem>
                        </asp:RadioButtonList>
