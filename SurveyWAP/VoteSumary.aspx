...
<%@ Page language="c#" MasterPageFile="~/Public.Master"   AutoEventWireup="false" Inherits="Votations.NSurvey.WebAdmin.VoteSumary" Codebehind="VoteSumary.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div id="DivPrint">
     ...
     // -->
                       ...
                       <div style="text-align:right; right:15px; top: 15px;">
         ...
         <fieldset style="width:100%; margin-left:12px; margin-top:15px; height:100% " title="">
            <legend class="titleFont" style="margin: 0px 15px 0 15px; text-align:left;">
