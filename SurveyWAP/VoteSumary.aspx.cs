...
namespace Votations.NSurvey.WebAdmin
{
	...
	/// </summary>
    public partial class VoteSumary : PageBase
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
            ...
            if (Information.IsNumeric(Request[Votations.NSurvey.Constants.Constants.QRYSTRGuid]))
            {
                SurveyId = int.Parse(Request[Votations.NSurvey.Constants.Constants.QRYSTRGuid]);
            }
            else
            {
                throw new FormatException("Invalid survey id!");
            }
