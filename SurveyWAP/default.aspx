...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div style="margin-top: -18px;">
        <img src="Images/NewBanner.png" class="imageDiv"></img></div>
    <div class="row" style="margin-top: 10px;">

        <div class="col-md-3">
            <div style="background-color: #4dcde8; align-items: center" class="text-center">
                <img src="Images/icon-bcn.jpg" class="pull-left" /><label class="text-uppercase divText">Ban chức năng</label><div class="clearfix"></div>
            </div>
        ...
        <div class="col-md-3">
            <div style="background-color: #f8901f; align-items: center;" class="text-center vcenter">
                <img src="Images/icon-vnptTinhTp.jpg" class="pull-left" /><label class="text-uppercase divText">VNPT Tỉnh/TP</label><div class="clearfix"></div>
            </div>
            <div class="panel panel-default">
                <div class="panel-body" style="min-height: 280px; max-height: 280px;">
        ...
        <div class="col-md-3">
            <div style="background-color: #56c253; align-items: center;" class="text-center vcenter">
                <img src="Images/icon-ctydoc.jpg" class="pull-left" /><label class="text-uppercase divText">Công ty dọc</label><div class="clearfix"></div>
            </div>
            <div class="panel panel-default">
                <div class="panel-body" style="min-height: 280px; max-height: 280px;">
        ...
        <div class="col-md-3">
            <div style="background-color: #d2469f; align-items: center;" class="text-center vcenter">
                <img src="Images/icon-ttkd.jpg" class="pull-left" /><label class="text-uppercase divText">TTKD VNPT Tỉnh/TP</label><div class="clearfix"></div>
            </div>
            <div class="panel panel-default">
                <div class="panel-body" style="min-height: 280px; max-height: 280px;">
